...
### Major enhancements
- 9613 Adds draft_graphs and the ability to update Graphs without unpublishing.
...
3. Create draft_graphs for your Resource Models using the command `python manage.py graph create_draft_graphs`. This will publish new versions of each Graph.
