        ...
        try:
            with transaction.atomic():
                ...
                def create_reference_data(new_concepts, create_collections):
                    ...
                    for arches_nodeid, concepts in list(new_concepts.items()):
                        ...
                        if node.datatype in ['concept', 'concept-list']:
                            ...
                            if collection != None:
                                ...
                                for conceptid, value in list(concepts.items()):
                            ...
                            for domainid, value in list(new_concepts[arches_nodeid].items()):
                ...
                def check_required_nodes(tile, parent_tile, required_nodes, all_nodes):
                    ...
                    if len(required_nodes) > 0:
                        if bool(tile.data):
                            for target_k, target_v in list(tile.data.items()):
                ...
                errors = []
                for k,v in list(missing_display_values.items()):
                    if len(v) > 0:
