...
const name = 'geojson-feature-collection-datatype-config';
const viewModel = function (params) {
    ...
    if (this.search) {
        ...
        if (this.layer) {
            ...
            const overlays = JSON.parse(this.layer.layer_definitions);
            const getDisplayLayers = function () {
                let displayLayers = overlays;
                if (self.config.advancedStyling()) {
                    const advancedStyle = self.config.advancedStyle();
                    try {
            ...
            const mapLayers = $.extend(true, {}, arches.mapLayers);
            ...
            let defaultBasemap = _.find(this.basemaps, function (basemap) {
            ...
            const getBasemapLayers = function () {
            ...
            const sources = $.extend(true, {}, arches.mapSources);
