...
class FunctionManager {
    constructor() {
        ...
        */
        ...
        const savedFunctions = ko.observableArray(_.map(data.applied_functions, function (fn) {
        ...
        viewModel.functionList.on('item-clicked', function (func) {
            const newAppliedFunction = new FunctionXGraphModel({
                id: null,
        ...
        const alertFailure = function (responseJSON) {
        ...
        viewModel.filterFunctions = function () {
            ...
            return function (applied) {
                const appliedIds = _.pluck(applied, 'function_id');
        ...
        */
        const pageView = new GraphPageView({
            viewModel: viewModel
        });
    }
}
