...
class ProvisionalHistoryList extends ListView {
    /**
    ...
    */
    initialize(options) {
        const self = this;
        const defaultDateRange = "last-30";
        ...
        this.updateRange = function (value) {
            const today = moment();
            let from = today.format(this.format);
            let to = today.add(1, 'days').format(this.format);
        ...
        const dateRange = this.updateRange(defaultDateRange);
